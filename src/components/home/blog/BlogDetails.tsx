...
useEffect(() => {
  ...
  <div className="container px-4">
    ...
    <div 
      className="grid md:  // Auto-scroll for all posts carousel
// Replace your existing auto-scroll useEffect with this:grid-cols-2 lg:grid-cols-4 gap-[30px]"
      onMouseEnter={() => {
        // Clear auto-scroll interval when user hovers over the section
        ...
        >
          ...
          <div className="flex-col justify-start items-start gap-2.5 flex px-4 pb-4 w-full">
            ...
            <div className="flex items-center gap-1 mt-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
              <span className="text-orange-600 dark:text-orange-400 text-sm font-medium">Read more</span>
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="16" 
                height="16" 
