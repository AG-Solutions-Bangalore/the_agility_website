...
export const onlinePresenceList: onlinePresence[] = [
  ...
  },
  {
    ...
    tag: 'Bring your legacy data into the future. We migrate, clean, and integrate old records into modern, secure, and user-friendly platforms',
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/ar.jpg',
    title: 'Analytics & Reporting',
    tag: 'Insights that drive action. We build dashboards and reports that help you track performance, understand behavior, and make smarter decisions.',
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/wd.jpg',
    title: 'Web Development',
    tag: 'Custom websites and platforms built for performance. From sleek front-ends to robust back-ends, we build responsive, secure, and scalable solutions —tailored to your brand and audience.',
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/md.jpg',
    title: 'Membership Drives & Cards',
    tag: 'Grow and engage your community with digital campaigns and smart membership systems, including physical or digital cards. We design, print, and integrate membership cards with your CRM or directory.',
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/pm.jpg',
    title: 'Print Media',
    tag: 'Connect your ecosystem. We build searchable, filterable directories that showcase members, partners, or resources with ease—complete with profiles, maps, and contact tools.',
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/em.jpg',
    title: 'Event Management',
    tag: 'From concept to execution, we design and manage events that inspire. Whether it’s a corporate conference, community gathering, or brand activation, we handle logistics, promotion, and on-ground coordination—so you can focus on creating impact.',
    link: 'https://www.wrappixel.com/',
  },
]
